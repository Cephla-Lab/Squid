...
`fluidics_config.yaml.example`; the real file is gitignored. Squid loads it when you press
Initialize in the Fluidics tab (path from `FLUIDICS_CONFIG_PATH`, overridable there).
