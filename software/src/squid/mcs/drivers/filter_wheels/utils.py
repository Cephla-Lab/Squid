...
def get_filter_wheel_controller(
    ...
    from squid.mcs.drivers.filter_wheels.cephla import SquidFilterWheel
    from squid.mcs.drivers.filter_wheels.optospin import Optospin
    from squid.mcs.drivers.filter_wheels.zaber import ZaberFilterController
