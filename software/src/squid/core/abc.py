...
from squid.core.config import StageConfig, CameraConfig, CameraPixelFormat
from squid.core.exceptions import SquidTimeout
...
class AbstractCamera(metaclass=abc.ABCMeta):
    ...
    def _process_raw_frame(
        ...
        image = squid.core.utils.hardware_utils.rotate_and_flip_image(
            raw_frame,
        ...
        image = squid.core.utils.hardware_utils.crop_image(image, crop_width, crop_height)
