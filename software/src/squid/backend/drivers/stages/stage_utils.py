...
from squid.core.abc import Pos, AbstractStage
from squid.core.config import StageConfig
import _def as _def
import squid.core.utils.hardware_utils

_log = squid.core.logging.get_logger(__package__)
_DEFAULT_CACHE_PATH = "cache/last_coords.txt"


def get_stage(
    stage_config: StageConfig,
    microcontroller=None,  # Type: squid.backend.microcontroller.Microcontroller
    ...
    if _def.USE_PRIOR_STAGE:
        from squid.backend.drivers.stages.prior import PriorStage
