...
from squid.core.config import FilterWheelConfig, FilterWheelControllerVariant
...
def get_filter_wheel_controller(
    ...
    from squid.backend.drivers.filter_wheels.cephla import SquidFilterWheel
    from squid.backend.drivers.filter_wheels.optospin import Optospin
    from squid.backend.drivers.filter_wheels.zaber import ZaberFilterController
