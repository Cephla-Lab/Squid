...
import _def
from squid.core.events import EventBus, ObjectiveChanged


class ObjectiveStore:
    def __init__(
        self,
        objectives_dict: Dict[str, Dict[str, Any]] = _def.OBJECTIVES,
        default_objective: str = _def.DEFAULT_OBJECTIVE,
