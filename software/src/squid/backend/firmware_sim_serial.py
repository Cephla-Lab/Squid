...
from squid.backend.drivers.stages.serial import AbstractCephlaMicroSerial
...
class FirmwareConstants:
    ...
    def __init__(self, firmware_path: Optional[Path] = None):
        if firmware_path is None:
            ...
            # From software/src/squid/backend/ go up 4 levels to repo root, then to firmware
            this_file = Path(__file__).parent
            firmware_path = this_file.parent.parent.parent.parent / "firmware" / "controller" / "src" / "constants_protocol.h"
