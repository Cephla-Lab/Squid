...
def connect_acquisition_signals(gui: "HighContentScreeningGui") -> None:
    ...
    Phase 8: Widgets also publish AcquisitionUIToggleCommand via EventBus.
    Qt signal connections are kept as primary mechanism for reliability.
    """
    # Qt signal connections (primary mechanism)
...
def connect_wellplate_signals(gui: "HighContentScreeningGui") -> None:
    ...
    Phase 8: main_window also subscribes to WellplateFormatChanged via EventBus.
    Qt signal connections kept as primary mechanism for reliability.
    """
