...
class FilterControllerWidget(QFrame):
    ...
    def add_components(self):
        ...
        layout.addWidget(
            QLabel("For acquisition, filter wheel positions need to be set in channel configurations."), 4, 0
        )
    ...
    def go_to_next_position(self):
        self.filterController.next_position()

    def go_to_previous_position(self):
        self.filterController.previous_position()
