...
def apply_acquisition_settings(
    ...
    if data.ome_tiff_split_timepoints is not None:
        # Same rule as large_acquisition_mode: only an explicit key opts this run in.
        controller.set_split_ome_timepoints(data.ome_tiff_split_timepoints)
