...
class LiveController:
    ...
    def set_trigger_mode(self, mode):
        if mode == TriggerMode.SOFTWARE:
            ...
            self.microscope.low_level_drivers.microcontroller.set_trigger_ready_mode(False)
        if mode == TriggerMode.HARDWARE:
            ...
            self.microscope.low_level_drivers.microcontroller.set_trigger_ready_mode(control._def.USE_TRIGGER_READY)
