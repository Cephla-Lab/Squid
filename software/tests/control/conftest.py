...
from squid.backend.firmware_sim_serial import FirmwareSimSerial
...
def cleanup_microcontrollers():
    ...
    original_init = squid.backend.microcontroller.Microcontroller.__init__

    with patch.object(
        squid.backend.microcontroller.Microcontroller, "__init__", _make_tracking_init(original_init, active_microcontrollers)
    ):
        yield
