...
def test_multi_point_worker_init_bugs(qtbot):
    ...
    multi_point_controller_for_false = gts.get_test_qt_multi_point_controller(
        microscope=scope_false
    )
    ...
    multi_point_controller_for_true = gts.get_test_qt_multi_point_controller(
        microscope=scope_true
    )
