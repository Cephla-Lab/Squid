...
Tests the two-tier channel configuration architecture:
- Tier 1: Global channel definitions (ChannelDefinitionsConfig)
- Tier 2: Per-objective settings (ObjectiveChannelSettings)
"""
