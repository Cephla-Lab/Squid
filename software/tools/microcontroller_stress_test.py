...
if __name__ == "__main__":
    ...
    ap.add_argument("--stage", action="store_true", help="Create a motion stage, home it, then use it in the stress test.")
    ap.add_argument("--no_loop_sleep", action="store_true", help="Do not sleep to yield the test thread.")
    ap.add_argument("--on_thread", action="store_true", help="Run the test on a daemon thread while the main thread spins")
